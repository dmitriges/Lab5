...
//создаёт объект пути к файлу в текущей рабочей директории.
    ...
    private void saveDefaultFile() {
        ...
        runAsyncTask(task, null, "Данные сохранены в data.xml");
    }
    ...
    private void saveAs(Stage stage) {
        ...
        runAsyncTask(task, null, "Данные сохранены в файл: " + file.getAbsolutePath());
    }
    ...
    private void loadDefaultFile() {
        ...
        runAsyncTask(task, null, "Данные загружены из data.xml. Нажмите Refresh.");
    }
    ...
    private void loadFrom(Stage stage) {
        ...
        runAsyncTask(task, null, "Данные загружены из файла: " + file.getAbsolutePath() + ". Нажмите Refresh.");
    }
